...
<div class="max-w-6xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.addresses.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition">
            + Tambah Alamat Baru
        </a>
    </div>
        ...
        @forelse($addresses as $address)
            <div class="border p-5 rounded-xl hover:border-blue-500 transition relative">
                ...
                <div class="mt-4 flex space-x-3">
                    <a href="{{ route('admin.addresses.edit', $address->id) }}" class="text-sm text-yellow-600 hover:text-yellow-700 font-semibold">Edit</a>
