...
<div class="max-w-2xl mx-auto mt-10 p-8 bg-white rounded-lg shadow-md">
    ...
    <form action="{{ isset($address) ? route('admin.addresses.create', $address->id) : route('admin.addresses.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-6 flex items-center justify-between">
            <a href="{{ route('admin.addresses.index') }}" class="text-gray-600 hover:underline text-sm">Kembali</a>
